...
export const metadata = {
  ...
  description:
    "Learn about Skyheights Academy, a private school in Lugbe Abuja founded in 2017, committed to academic excellence, safety, and character development."
};
    ...
    <>
      ...
      <SectionContainer background="white">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-lg text-text-grey leading-relaxed mb-6">
            ...
            Lugbe, Abuja, offering quality education from Creche through
            Secondary School. Since our establishment, we have remained
            dedicated to nurturing young minds in a{" "}
            <strong>
              secure, disciplined, and academically enriching environment
            </strong>
            .
          </p>
          <p className="text-lg text-text-grey leading-relaxed">
            Our institution serves families who value structured learning,
            character formation, and academic preparation. We provide a
            purposeful educational experience that equips students with the
            knowledge, skills, and values needed for success in both their
      ...
      <SectionContainer background="light">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-lg text-text-grey leading-relaxed mb-6">
            ...
            academic excellence, moral values, and practical life skills.
          </p>
          <p className="text-lg text-text-grey leading-relaxed">
            Over the years, the school has grown into a trusted learning
            institution serving families who value quality education and
            character formation. Our continued commitment to educational
            standards, safety, and student development has established us as a
            reliable partner in the academic journey of our pupils.
          </p>
        </div>
      </SectionContainer>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-text-grey leading-relaxed">
              To foster each child&apos;s well-being and lay a strong foundation
          ...
          >
            ...
            <p className="text-text-grey leading-relaxed">
              To envision a world where every child, regardless of background,
              grows into a healthy, confident, and productive adult.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-text-grey text-sm">
              This guiding principle shapes every aspect of our educational
              practice.
            </p>
          </div>
        </div>
      ...
      <SectionContainer background="light">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-lg text-text-grey leading-relaxed mb-8">
            ...
            and holistic development to prepare pupils for both examinations and
            life.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              {
                principle:
                  "Blended Nigerian, British, and Montessori curricula",
                detail:
                  "Combining proven educational frameworks for comprehensive learning"
              },
              {
                principle: "Emphasis on discipline and character",
                detail:
                  "Developing responsible, respectful, and resilient individuals"
              },
              {
                principle: "Child-centered learning",
                detail:
                  "Recognizing and nurturing each student's unique strengths"
              },
              {
                principle: "Continuous assessment and growth",
                detail:
                  "Regular evaluation to support ongoing academic progress"
              }
            ].map((item, index) => (
              <div
                key={index}
      ...
      <SectionContainer background="white">
        <div className="max-w-4xl mx-auto">
          ...
          <div
            className="bg-light-grey rounded-[14px] p-8 md:p-12 mt-8"
            style={{ boxShadow: "0 1px 3px 0 rgba(0, 0, 0, 0.05)" }}
          >
            <div className="space-y-6 text-text-grey text-lg leading-relaxed">
              <p>
                At Skyheights Academy, our commitment goes beyond academic
                instruction. We are deeply invested in shaping confident,
                disciplined, and responsible individuals who are prepared for
                the future.
              </p>
              <p>
                We understand the trust parents place in us, and we do not take
                this responsibility lightly. Our team of dedicated educators and
                staff work tirelessly to ensure that every child receives
                quality education in a safe and supportive environment.
              </p>
              <p>
                Education is a partnership between the school and the home. We
                value the involvement of parents in their child&apos;s learning
                journey and maintain open communication to support each
                student&apos;s growth and development.
              </p>
              <p>
                We look forward to partnering with parents in nurturing the
                leaders of tomorrow.
              </p>
      ...
      <SectionContainer background="light">
        <SectionHeader
          ...
          subtitle="Our distinctive strengths"
          centered
        />
          ...
          {[
            {
              ...
              description:
                "Qualified teaching staff committed to student success and professional development"
            },
            {
              title: "Secure Learning Environment",
              description:
                "24-hour CCTV surveillance and strict safety protocols ensure student protection"
            },
            {
              title: "Blended Curriculum with Global Relevance",
              description:
                "Nigerian, British, and Montessori approaches prepare students for local and international success"
            },
            {
              title: "Strong Emphasis on Discipline and Values",
              description:
                "Character education integrated into daily learning and school culture"
            },
            {
              title: "Purpose-Built Learning Facilities",
              description:
                "Well-equipped classrooms, laboratories, library, and ICT facilities support quality education"
            },
            {
              title: "Structured Academic Support",
              description:
                "Regular assessments, parent communication, and individualized attention promote progress"
            }
          ].map((item, index) => (
            <div
              key={index}
      ...
      <SectionContainer background="white">
        <div className="max-w-4xl mx-auto bg-cream rounded-[14px] p-8 md:p-12 text-center">
          ...
          <p className="text-lg text-text-grey mb-8 leading-relaxed max-w-2xl mx-auto">
            We invite you to explore our academic programmes and admission
            process, and discover how Skyheights Academy can support your
